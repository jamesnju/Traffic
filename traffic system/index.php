...
<head>
    <title>Traffic Fine Management System</title>

    <!--Meta tags start-->
    <meta charset="UTF-8">
    <meta name="description" content="Smart Traffic Fine Management System for NTSA Kenya>
    <meta name="keywords" content="Traffic, Fine, System, NTSA Kenya">
    <meta name="author" content="victor mwangi">
    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            <li class="topnav-item">
                <a href="index.php"><img src="assets/img/logo_text.svg" alt="NTSA fines logo" class="logo logo-light"></a>            
            </li>
        </ul>
        <!-- end topnav left -->
        <!-- topnav right -->
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="tel:+94714590249"><i class="fas fa-phone"></i> +254 790344988</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Inquiry via email</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:mwangivictor760@gmail.com" target="_blank"> <i class="fas fa-envelope"></i>mwangivictor760@gmail.com</a></li>
                        </ul>
