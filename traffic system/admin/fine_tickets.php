							...
							<table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<td class="d-flex justify-content-around">	<!--consider about row and res when edit button add-->									
										<button type="button" name="edit" value="Edit" id="<?php echo $res["fine_tickets_id"]; ?>" class="btn btn-success btn-xs edit_data"><i class="fas fa-pen"></i></button>
										<button type="button" name="delete" value="Delete" id="<?php echo $res["fine_tickets_id"]; ?>" class="btn btn-danger btn-xs delete_data"><i class="fas fa-trash-alt"></i></button>
									</td>
