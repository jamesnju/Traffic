                        ...
                        <div class="table-responsive" id="employee_table">
                            ...
                            <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr> 
										<td>
											<button type="button" name="edit" id="<?php echo $row["tpo_id"]; ?>" class="btn btn-success btn-xs edit_data"><i class="fas fa-pen"></i></button>											
											<button type="button" name="delete" id="<?php echo $row["tpo_id"]; ?>" class="btn btn-danger btn-xs delete_data"><i class="fas fa-trash-alt"></i></button>								
										</td>										
										<td><?php echo $row["tpo_id"] ?></td>
										<td><?php echo $row["tpo_name"] ?></td>
										<td><?php echo $row["tpo_station"] ?></td>
									
										<td><?php echo $row["tpo_email"] ?></td>
										<td><?php echo $row["tpo_registered_at"] ?></td>									
									</tr>
									<?php	
									  }
									?>
