 ...
 {    
      ...
      $license_expire_date = mysqli_real_escape_string($cnn, $_POST["license_expire_date"]);
      ...
      {  
           $query = "  
           UPDATE driver   
           SET driver_license_id='$license_id',
           driver_driver_email='$driver_email',
           driver_home_address='$address',
		   driver_name='$driver_name',
		   driver_license_issue_date='$license_issue_date',
		   driver_license_expire_date='$license_expire_date',
		   driver_class_of_vehicle='$class_of_vehicle',
             driver_registered_at='$registered_date'
              
           WHERE driver_license_id='".$_POST["did"]."'";  
