 ...
 {    
      ...
      {  
           $query = "  
           UPDATE fine_tickets   
           SET fine_tickets_id='$fine_id',fine_tickets_section_of_act='$section_of_act',fine_tickets_provision='$provision',fine_tickets_amount='$fine_amount' WHERE fine_tickets_id='".$_POST["did"]."'";  
