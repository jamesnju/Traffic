            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="tel:+94714590249"><i class="fas fa-phone"></i> +254790344988</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Inquiry via email</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:stfms@gmail.com" target="_blank"> <i class="fas fa-envelope"></i> mwangivictor760@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Navigate to</h4>
