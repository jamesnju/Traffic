...
$sql = "SELECT * FROM tpo WHERE tpo_id = '$owner'";
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="reference_no" value="<?php echo $row['tpo_id']; ?>" disabled placeholder="Officer ID" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="vehicle_no">Office Name</label>
                                <input type="text" class="form-control" id="vehicle_no" placeholder="Officer Name" value="<?php echo $row['tpo_name']; ?>" disabled>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="license_duration">Email</label>
                                <input type="text" class="form-control" id="vehicle_type" placeholder="Officer Email" value="<?php echo $row['tpo_email']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="vehicle_owner">Police Station</label>
                                <input type="text" class="form-control" id="fuel_type" placeholder="Police Station" value="<?php echo $row['tpo_station']; ?>" disabled>
                            </div>
                        </div>
                        
                            <div class="form-group col-md-6">
                                <label for="amount">Registered Date</label>
                                <input type="text" class="form-control" id="owner_address" placeholder="Registered Date" value="<?php echo $row['tpo_registered_at']; ?>" disabled>
                            </div>
                        </div>
                                </form>
                                <?php
