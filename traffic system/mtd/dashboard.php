...
<?php
    include "../connection.php";
    $year = date("Y");
    $jan = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 01 AND YEAR(driver_registered_at) = '$year'");
    $janVal = mysqli_num_rows($jan);

    $feb = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 02 AND YEAR(driver_registered_at) = '$year'");
    $febVal = mysqli_num_rows($feb);

    $march = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 03 AND YEAR(driver_registered_at) = '$year'");
    $marchVal = mysqli_num_rows($march);

    $april = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 04 AND YEAR(driver_registered_at) = '$year'");
    $aprilVal = mysqli_num_rows($april);

    $may = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 05 AND YEAR(driver_registered_at) = '$year'");
    $mayVal = mysqli_num_rows($may);

    $june = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 06 AND YEAR(driver_registered_at) = '$year'");
    $juneVal = mysqli_num_rows($june);

    $july = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 07 AND YEAR(driver_registered_at) = '$year'");
    $julyVal = mysqli_num_rows($july);

    $august = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 08 AND YEAR(driver_registered_at) = '$year'");
    $augustVal = mysqli_num_rows($august);

    $september = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 09 AND YEAR(driver_registered_at) = '$year'");
    $sepVal = mysqli_num_rows($september);

    $october = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 10 AND YEAR(driver_registered_at) = '$year'");
    $octVal = mysqli_num_rows($october);

    $november = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 11 AND YEAR(driver_registered_at) = '$year'");
    $novVal = mysqli_num_rows($november);

    $december = mysqli_query($con, "SELECT driver_license_id FROM driver WHERE MONTH(driver_registered_at) = 12 AND YEAR(driver_registered_at) = '$year'");
