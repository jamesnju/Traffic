...
if (isset($_POST['licenseid']) && isset($_POST['driveremail'])
	...
	if (empty($licenseid)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $sql2 = "INSERT INTO driver(driver_license_id, driver_email, driver_password, driver_name, driver_home_address, driver_license_issue_date, driver_license_expire_date, driver_class_of_vehicle, driver_registered_at, driver_status) VALUES('$licenseid', '$driveremail', '$driverpassword', '$drivername', '$homeaddress', '$licenseissuedate', '$licenseexpiredate', '$classofvehicle', NOW(), 'verified')";
